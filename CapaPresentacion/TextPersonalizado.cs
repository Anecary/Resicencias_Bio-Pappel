...
namespace CapaPresentacion
{
    ...
    public partial class TextPersonalizado : UserControl
    {
        ...
        private GraphicsPath GetFigurePath(Rectangle rect, int radius)
        {
            ...
            // Validar que radius no sea mayor que la mitad del tamaño del rectángulo
            int maxRadius = Math.Min(rect.Width, rect.Height) / 2;
            radius = Math.Max(1, Math.Min(radius, maxRadius));
        ...
        public event EventHandler ClearCalled;

        // Método público para limpiar el texto
        public void Clear()
        {
            this.Text = ""; // Limpia el contenido
            OnClearCalled(EventArgs.Empty); // Lanza el evento
        }

        // Método protegido para lanzar el evento
        protected virtual void OnClearCalled(EventArgs e)
        {
            ClearCalled?.Invoke(this, e);
        }
    }
